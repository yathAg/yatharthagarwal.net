...
function getContentDirectoryTree(root) {
    return {
        ...
        experiencesSection: path.join(root, ContentFolder.Sections, ContentFolder.ExperiencesSection),
...
function getExampleFiles(directory) {
    ...
    return {
        ...
        experiencesSection: {
            destination: path.join(directory['experiencesSection'], 'experiences.json'),
        },
        aboutSection: {
